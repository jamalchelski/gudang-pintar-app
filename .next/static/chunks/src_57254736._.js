...
const AppProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppProvider.useEffect": ()=>{
            const fetchInventory = {
                "AppProvider.useEffect.fetchInventory": async ()=>{
                    setLoading(true);
                    try {
                        const inventoryCollection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'inventory');
                        const snapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])(inventoryCollection);
                        if (snapshot.empty) {
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_INVENTORY"].forEach({
                                "AppProvider.useEffect.fetchInventory": (item)=>{
                                    const docRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(inventoryCollection, item.id);
                                    batch.set(docRef, item);
                                }
                            }["AppProvider.useEffect.fetchInventory"]);
                            await batch.commit();
                            setInventory(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_INVENTORY"]);
                            toast({
                            ...
                            const inventoryData = snapshot.docs.map({
                                "AppProvider.useEffect.fetchInventory.inventoryData": (doc)=>({
                                        id: doc.id,
                                        ...doc.data()
                                    })
                            }["AppProvider.useEffect.fetchInventory.inventoryData"]);
    ...
    const reduceStock = async (itemId, amount)=>{
...
_s(AppProvider, "HtYArHYyoHHumUARYAxmWELVveQ=", false, function() {
    return [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: role === 'admin' ? 'admin@gudang.com' : 'user@gudang.com'
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/app-layout.tsx",
                                                lineNumber: 61,
                                                columnNumber: 15
...
_s(AppLayout, "29JLi5PQyZxIJsWwfnV/Vh2IYuI=");
_c = AppLayout;
var _c;
...
//# sourceMappingURL=src_57254736._.js.map